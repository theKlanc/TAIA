...
long Aresta::getDestination()
{
	return _n2->getUUID();
}

long Aresta::getOrigin()
{
	return _n1->getUUID();
}

void Aresta::setColor(int r, int g, int b)
{
	_shape->setFillColor(sf::Color(r, g, b));
}
